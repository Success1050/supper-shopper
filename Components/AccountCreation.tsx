...
//     emailOrPhone: "John.Doe@Email.Com",
//     firstName: "John",
//     lastName: "Doe",
//     verificationCode: "",
//     country: "John.Doe@Email.Com",
...
//             className="w-full bg-[#2723FF] hover:bg-blue-700 text-white font-semibold py-4 rounded-lg transition-colors"
//           >
